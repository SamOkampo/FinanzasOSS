...
- [x] 4.5 Normalización/revocación/errores
...
Las Fases 17+ permanecen definidas como Post-MVP en el historial del roadmap y fuera del alcance de ejecución automática.
